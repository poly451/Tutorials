...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # ---------------------------------------------
        filepath = os.path.join("data/img", settings.PLAYER_IMG)
        try:
...
class Game:
    def __init__(self):
        ...
        self.display_surface.fill(settings.RED)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_LEFT:
                    ...
                    self.player.direction = settings.RIGHT
                    ...
                    self.player.direction = settings.DOWN
                    ...
                    if self.player.direction == settings.DOWN:
                        ...
                        self.player.image = pygame.transform.rotate(self.player.image, 90)
                    self.player.move(dy=-1, walls=self.walls)
                    self.player.direction = settings.UP
...
class Wall(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.x = x
        self.y = y
        filepath = os.path.join("data/img", settings.WALL_IMG)
        try:
            self.image = pygame.image.load(filepath).convert_alpha()
        except:
            s = "Couldn't open: {}".format(filepath)
...
class Grass(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        filepath = os.path.join("data/img", settings.GRASS_IMG)
        try:
            self.image = pygame.image.load(filepath).convert_alpha()
        except:
            s = "Couldn't open: {}".format(filepath)
