...
def main():
    ...
    while run_program:
        ...
        while not ur in choices:
            ...
            ur = input(con.PROMPT).strip().lower()
        # -----------------------------------------
        origin_directory = "/Users/karenfriesen/Documents/Programming/Python/data"
        destination_directory = "/Users/karenfriesen/Desktop"
        filename = "cookies.txt"
        # ---- Move File ----
        if ur == "1":
            origin_directory = "/Users/karenfriesen/Music/iTunes/iTunes Media/Music/Unknown Artist/Unknown Album/"
