...
import constants
import os, sys
from environment import Walkables
...
class Player(pygame.sprite.Sprite):
    ...
    def move(self, advance_x, advance_y, x, y):
        myinc = self.movement_increment
        dx = myinc * advance_x # if advance_x = 0 then dx will be 0 and sprite will not move along that axis.
        dy = myinc * advance_y # if advance_y = 0 then dy will be 0 and sprite will not move along that axis.
...
# ------------------------------------------------------
class Game:
    def __init__(self, directory_name, movement_increment, step_size):
        ...
        self.x, self.y = 0, 0
        self.environment = Walkables("testing", "map01")
