...
MODEL_TYPES = ["lpc"]
MODEL_NAMES = ["henry"]
SHEET_KINDS = ["base", "slash", "stand", "thrust", "unconscious"]
DIRECTION_VALUES = ["front", "back", "right", "left"]

MAPKINDS = ["walkables", "obstacles", "eatables", "persistentslower", "persistentsupper"]
MAPKINDS += ["travel", "grid"]

LIST_OR_SPRITESHEET = ["list", "spritesheet"]

COMMANDS = ["monster", "sheet", "health", "load", "save"]

IMAGES = "/Users/BigBlue/Documents/Programming/game_resources/images"
# IMAGES = os.path.join("data", "images", )


MOVEMENT_VALUES = ["walk", "slash", "spell", "fall", "idle", "thrust", "unconscious", "bow"]
# SHEET_KINDS = ["base", "sword", "dagger", "bow", "dagger", "armour", "shield", "thrust", "weapons"]
DATA_VALUES = SHEET_KINDS + MOVEMENT_VALUES + ["file"]
